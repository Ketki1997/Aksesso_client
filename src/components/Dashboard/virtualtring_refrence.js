...
function VirtualTrainingRef() {
    ...
    function onSubmit(fields) {
        ...
        var path =JSON.parse(localStorage.getItem("vedio"));
      console.log(path);
            ...
            {({ errors, values, touched, setValues }) => (
                <Form>
                    <div className="card m-3">
                        <h5 className="card-header">Add Sections</h5>
                                    ...
                                    <div className="list-group-item">
                                        ...
                                        <div className="form-row">
                                            ...
                                            <div className="form-group col-6">
                                              ...
                                              <Field name={`tickets.${i}.file`}   type="file" className={'form-control' + (ticketErrors.file && ticketTouched.file ? ' is-invalid' : '' )} />
                                                <ErrorMessage name={`tickets.${i}.file`} component="div" className="invalid-feedback" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
export  default VirtualTrainingRef ;
